    ...
    public static EmbedBuilder getEmbed() {
        ...
        EmbedBuilder eb = new EmbedBuilder()
                ...
                .setDescription("Olá jogador! <:ZeroTwoGreeting:884744365711454238> \n" +
                        ...
                        "\n" +
                        "<:minecraft_beacon:1104573758213193808>  **Geral:**\n" +
                        ...
                        //"> **Proteção DDoS:** " + ((Boolean.valueOf((ddosData.get("online").toString()))) ? "Online :green_heart:" : "Offline :broken_heart:") +"\n" +
                        "\n" +
        ...
        if (
                ...
                //&& Boolean.valueOf((ddosData.get("online").toString()))
                && isBedrockOnline
